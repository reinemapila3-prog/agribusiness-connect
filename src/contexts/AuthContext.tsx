...
type AppRole = "agriculteur" | "restaurateur" | "grande_surface";
...
export const getRoleDashboardPath = (role: AppRole): string => {
  switch (role) {
    ...
    case "restaurateur": return "/dashboard/restaurateur";
    case "grande_surface": return "/dashboard/grande-surface";
  }
};
